...
class TurtlebotMover:
    ...
    def get_gazebo_model_state(self):
        ...
        try:
            ...
            resp = get_model_state('mobile_base', '')  # Replace with your robot's model name
            return resp.pose
...
if __name__ == "__main__":
    ...
    # origin = [int(0), int(0)]  # You probably don't want to hardcode the origin. You want the robot's current position.
    ...
    try:
        ...
        for step in shortest_path:
            ...
            while not rospy.is_shutdown():
                ...
                # Print current pose
                # print("Current pose: {}".format(mover.current_pose))
